...
export default function ReservationModal({ car, handleCloseModal }) {
    ...
    return (
        <>
            {showConfirmationModal ? <Modal closeModal={handleCloseModal}>
                <div className="flex flex-row justify-between px-5 bg-blue-500 h-14 w-full">
                    ...
                    <button onClick={handleCloseModal} className="text-white text-2xl font-bold">X</button>
                </div>
                    ...
                    <form onSubmit={handleSubmit}>
                        ...
                        <div className="w-full mx-auto px-6 mt-6">
                            ...
                            <div className="mt-8 pb-10">
                                ...
                                {isError && <p className="text-center text-red-500 mb-4">{error.message}</p>}
