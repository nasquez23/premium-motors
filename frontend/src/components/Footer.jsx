...
export default function Footer() {
  return (
    <footer className="w-full bg-gray-800 p-4">
      <div className="w-3/4 max-lg:w-[85%] m-auto grid grid-cols-5 max-lg:grid-cols-3 justify-between text-center p-4 pb-16 border-b-2 border-gray-600 text-gray-200 max-lg:text-[15px]">
        <div className="col-span-2 max-lg:col-span-2 max-lg:mb-10">
          <h3 className="text-2xl pb-4 font-medium text-left text-white">Premium Motors</h3>
        ...
        <div className="text-left">
          <h3 className="text-2xl pb-4 font-medium text-white">Company</h3>
          <p className="py-1">Terms of Service</p>
          <p className="py-1">Privacy Policy</p>
          <p className="py-1">FAQ</p>
          <p className="py-1">Careers</p>
        </div>
        <div className="max-lg:col-span-2 text-left">
          <h3 className="text-2xl pb-4 font-medium text-white">Our Product</h3>
          <p className="py-1">New Cars</p>
          <p className="py-1">Used Cars</p>
          <p className="py-1">Car Accessories</p>
        </div>
        <div className="text-left">
          <h3 className="text-2xl pb-4 font-medium mb-2 text-white">Follow Us</h3>
