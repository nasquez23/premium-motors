...
export default function WhyChooseUs() {
  return (
    <section className="flex flex-row my-10">
      <img src={logo} alt="Lamborghini" className="w-2/3 h-2/3 -ml-52 hidden lg:block xl:block" />
      <div className="w-full lg:w-1/2 xl:w-1/2 lg:ml-20 xl:ml-20 mt-10">
        ...
        <div className="mb-20 lg:mb-10 xl:mb-10 flex flex-col lg:flex-row xl:flex-row">
          <div className="w-20 h-20 lg:w-12 lg:h-12 xl:w-12 xl:h-12 text-3xl lg:text-base xl:text-base text-center mr-4 ml-60 xl:ml-0 lg:ml-0 mt-4 mb-8 xl:mb-0 lg:mb-0 pt-3 bg-blue-100 rounded-lg">
            <FontAwesomeIcon icon={faCheckCircle} className="text-blue-600 pt-3 xl:pt-0 lg:pt-0" />
          </div>
          <div className="text-center lg:text-left xl:text-left">
            <h3 className="text-xl mb-4 lg:mb-0 xl:mb-0 font-bold text-gray-700">
              Quality Products
            </h3>
        ...
        <div className="mb-20 lg:mb-10 xl:mb-10 flex flex-col lg:flex-row xl:flex-row">
        <div className="w-20 h-20 lg:w-12 lg:h-12 xl:w-12 xl:h-12 text-3xl lg:text-base xl:text-base text-center mr-4 ml-60 xl:ml-0 lg:ml-0 mt-4 mb-8 xl:mb-0 lg:mb-0 pt-3 bg-blue-100 rounded-lg">
            <FontAwesomeIcon icon={faHandshake} className="text-blue-600 pt-3 xl:pt-0 lg:pt-0" />
          </div>
          <div className="text-center lg:text-left xl:text-left">
            <h3 className="text-xl mb-4 lg:mb-0 xl:mb-0 font-bold text-gray-700">
              Exceptional Service
        ...
        <div className="w-20 h-20 lg:w-12 lg:h-12 xl:w-12 xl:h-12 text-3xl lg:text-base xl:text-base text-center mr-4 ml-60 xl:ml-0 lg:ml-0 mt-4 mb-8 xl:mb-0 lg:mb-0 pt-3 bg-blue-100 rounded-lg">
            <FontAwesomeIcon icon={faTag} className="text-blue-600 pt-3 xl:pt-0 lg:pt-0" />
          </div>
          <div className="text-center lg:text-left xl:text-left">
            <h3 className="text-xl mb-4 lg:mb-0 xl:mb-0 font-bold text-gray-700">
              Affordable Pricing
